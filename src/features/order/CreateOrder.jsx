...
function CreateOrder() {
    ...
    return (
        ...
        <label className="space-y-1" onSubmit={e=>e.preventDefault()}>
            ...
            <input type="text" name="name" id="" className="i w-full py-3 rounded-full focus:ring focus:outline-none focus:ring-yellow-200 focus:ring-offset-1 indent-5"/>

        </label>
        <label className="space-y-1">
            <p className="text-neutral-500 text-lg pl-3  ">Phone Number</p>
            <input type="text" name="phone" id="" className="w-full py-3 rounded-full focus:ring focus:outline-none focus:ring-yellow-200 focus:ring-offset-1 indent-5"/>

        </label>
        <label className="space-y-1">
            <p className="text-neutral-500 text-lg pl-3  ">Address</p>
            <input type='tel' name="address" id="" className="w-full py-3 rounded-full focus:ring focus:outline-none focus:ring-yellow-200 focus:ring-offset-1 indent-5"/>
        ...
        <div className="grid grid-cols-[.7fr_2fr]">
            ...
            <Button type='primary' handleClick={e=>e.preventDefault()}>Order now</Button>
        </div>
        </Form>
        </div>
    )
